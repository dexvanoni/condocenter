...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="mb-0"><i class="bi bi-gear"></i> Administrar Reservas</h3>
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        <div class="d-flex gap-2">
                            ...
                            <button type="button" class="btn btn-outline-info btn-sm" onclick="exportFiltered()">
                                <i class="bi bi-download"></i> Exportar Filtrado
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-danger text-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="bi bi-calendar3"></i> Todas as Reservas</h5>
            <div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title" id="viewModalLabel">Detalhes da Reserva</h5>
        ...
        <div class="modal-content">
            <form id="editForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="editAdminReason" class="form-label">Motivo da Alteração (Obrigatório se houver mudanças significativas)</label>
                        <textarea class="form-control" id="editAdminReason" name="admin_reason" rows="2" placeholder="Explique o motivo das alterações..."></textarea>
                    </div>
                </div>
                <div class="modal-footer">
        ...
        <div class="modal-content">
            <form id="deleteForm">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title" id="deleteModalLabel">Cancelar Reserva</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="deleteAdminReason" name="admin_reason" rows="3" required placeholder="Explique o motivo do cancelamento..."></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
        ...
        <div class="modal-content">
            <form id="bulkActionForm">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="bulkActionModalLabel">Ação em Massa</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
...
$(document).ready(function() {
    ...
    $(document).on('change', '.reservation-checkbox', function() {
        ...
        // Atualizar checkbox "Selecionar Tudo"
    ...
    $('#bulkActionForm').on('submit', function(e) {
        ...
        $.ajax({
            url: "{{ route('admin.reservations.bulk-action') }}",
            type: 'POST',
            data: {
    ...
    function loadSpaces() {
        $.get('/admin/reservations/spaces/list')
            .done(function(spaces) {
                var spaceSelect = $('#filterSpace');
    ...
    function loadReservations() {
        ...
        $.get("{{ route('admin.reservations.index') }}", filters)
        ...
        $.get("/admin/reservations/" + id)
            .done(function(data) {
                ...
                if (data.admin_action) {
                    html += `<div class="mt-3 alert alert-info"><strong>Ação Administrativa:</strong> ${getActionText(data.admin_action)}<br><strong>Motivo:</strong> ${data.admin_reason}</div>`;
                }
    ...
    window.exportFiltered = function() {
        ...
        // Criar URL com filtros
        var params = new URLSearchParams(filters);
        var url = "{{ route('admin.reservations.index') }}?" + params.toString();
