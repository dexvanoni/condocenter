        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0"><i class="bi bi-hearts"></i> Cadastrar Novo Pet</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('pets.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" 
                                ...
                                <option value="bird" {{ old('type') == 'bird' ? 'selected' : '' }}>Pássaro</option>
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>QR Code:</strong> Ao cadastrar o pet, um QR Code será gerado automaticamente. 
                            Você poderá baixá-lo e imprimir para fixar na coleira do animal.
                        </div>

                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save"></i> Cadastrar Pet
                            </button>
...
$(document).ready(function() {
            ...
            success: function(data) {
                ...
                if (data.length === 0) {
                    ...
                    data.forEach(function(owner) {
                        options += `<option value="${owner.id}">${owner.name}${owner.phone ? ' - ' + owner.phone : ''}</option>`;
                    });
                }
    ...
    // Se houver uma unidade pré-selecionada (no caso de erros de validação)
    @if(old('unit_id'))
