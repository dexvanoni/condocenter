...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Morador' role button to select the resident profile.
        ...
        # --> The current user profile name 'João da Silva' is visible in the navigation.
        # Assert-outcome: passed
        # Assert: Verify the profile name 'João da Silva' appears in the nav.
        await expect(page.locator("#dropdownUser").nth(0)).to_contain_text("Jo\u00e3o da Silva", timeout=15000), "Verify the profile name 'Jo\u00e3o da Silva' appears in the nav."
